    ...
    return Scaffold(
        ...
        body: ListView(
          children: [
            ...
            SettingsComponent(
              settingsComponentName: S.of(context).notification,
              contents: const [],
            ),
            SettingsComponent(
              settingsComponentName: S.of(context).language,
              contents: [
                BlocBuilder<RadioButtonCubit, RadioButtonStates>(
                  builder: (context, state) => Column(
                    ...
                    children: [
                      RadioListTile(
                        title: Text(S.of(context).arabicLanguage),
                        value: "ar",
                        groupValue: RadioButtonCubit.get(context).currentValue,
                        onChanged: (value) {
                          LocalizationCubit.of(context)
                              .changeLocalization(value.toString());
                          RadioButtonCubit.get(context)
                              .changeRadioButton(value: value.toString());
                        },
                      ),
                      RadioListTile(
                        title: Text(S.of(context).englishLanguage),
                        value: "en",
                        groupValue: RadioButtonCubit.get(context).currentValue,
                        onChanged: (value) {
                          LocalizationCubit.of(context)
            ...
            SettingsComponent(
              settingsComponentName: S.of(context).privacyAndSecurity,
              contents: [
                Text(
            ...
            SettingsComponent(
              settingsComponentName: S.of(context).helpAndSupport,
              contents: [
                Text.rich(
                  TextSpan(
                    children: [
            ...
            SettingsComponent(
              settingsComponentName: S.of(context).about,
              contents: [
                Text(
